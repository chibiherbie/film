...
def get_lenght(file_num):
    ...
    file = f'/Volumes/Seagate Backup Plus Drive/фильм 2/{file_num}.mp4'
...
def get_path(file_num):
    ...
    # /Volumes/Seagate Backup Plus Drive/фильм 2
    return f'/Volumes/Seagate Backup Plus Drive/фильм 2/{file_num}.mp4'
